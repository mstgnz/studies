...
<head>
    ...
    <title>Auto Capitalize Sentences - WordCounter.net</title>
    <meta name="description"
        content="Auto Capitalize Sentences is a free online tool that auto capitalizes the first letter of every sentence." />
    <meta name="keywords"
        content="auto capitalize, auto capitalize sentences, capitalize first letter of every sentence, capitalize first letter, capitalize, sentence capitalization, capitalize sentences." />
    <meta property="og:image" content="https://wordcounter.net/images/auto-capitalize.jpg" />
                        ...
                        <div class="col-md-5">
                            <div class="login-form ">
                                <div class="site-login-form">
                                    ...
                                    <form id="login-form" class="" action="/user/security/login" method="post"><input
                                            ...
                                            value="TmNQaE1vQ2ctNgI6dQI3HhkAG1l6JjUWIRMZCRlaE1UnFCVbGVscIA==">
                            ...
                            <div class="signup-form hidden">
                                ...
                                <form id="signup-form" class="" action="/site/signup" method="post"><input type="hidden"
                                        name="_csrf" value="TmNQaE1vQ2ctNgI6dQI3HhkAG1l6JjUWIRMZCRlaE1UnFCVbGVscIA==">
                                    <div class="error-summary alert alert-danger" style="display:none">
                                        <ul></ul>
                                    </div>
