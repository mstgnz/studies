...
<head>
    ...
    <title>Website Page Word Counter - WordCounter.net</title>
    <meta name="description"
        content="Website Word Count is a free online tool that counts the words on any website page and gives the top keywords. Simply type in the url." />
    <meta name="keywords" content="website word counter, website page counter, words on a website" />
    <meta property="og:image" content="https://wordcounter.net/images/website-word-count.jpg" />
                                ...
                                <div class="site-login-form">
                                    ...
                                    <form id="login-form" class="" action="/user/security/login" method="post">
                                        <input type="hidden" name="_csrf"
                                            value="d1FVTS1mLVEUBAcfFQtZKCAyHnwaL1sgGCEcLHlTfWMeJiB.eVJyFg==">
